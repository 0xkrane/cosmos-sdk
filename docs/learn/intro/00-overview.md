...
* It allows you to plug and play and customize your consensus layer. As above you can build a rollup using Rollkit to in turn use Celestia as your consensus and data availability layer. This offers a lot of flexibility and customisation. 
